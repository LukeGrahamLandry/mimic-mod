...
public class FabricGeoMimicEntity extends MimicEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public FabricGeoMimicEntity(EntityType<? extends MimicEntity> type, Level world) {
        super(type, world);
    }
