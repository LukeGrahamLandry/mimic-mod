...
public class ItemInit {
    ...
    public static final RegistryObject<Item> MIMIC_SPAWN_EGG = ITEMS.register("mimic_spawn_egg", () -> new ModSpawnEgg(EntityInit.MIMIC, 0xad7110, 0x0, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
